...
export const installmentPlanSchema = z.object({
  ...
  installments: z.number().int().min(1, "Las cuotas deben ser al menos 1").max(60, "Las cuotas no pueden ser más de 60"),
  interestRate: z.number().min(0, "La tasa de interés no puede ser negativa").max(100, "La tasa de interés no puede superar el 100%"),
