...
export const motorcycleBatchSchema = z.object({
  // Producto
  brandId: z
    .number({ required_error: "Debe seleccionar una marca." })
    .min(1, "Debe seleccionar una marca."),
  modelId: z
    .number({ required_error: "Debe seleccionar un modelo." })
  ...
  year: z
    ...
    .min(1900, "El año parece muy antiguo.")
    .max(new Date().getFullYear() + 1, "El año no puede ser futuro."),
  displacement: z
    .number({
      invalid_type_error: "La cilindrada debe ser un número.",
    })
    .positive("La cilindrada debe ser positiva.")
    .nullable()
    .optional(),
