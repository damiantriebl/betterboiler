...
export const pettyCashDepositStatusEnum = z.enum([
  "OPEN",
  "CLOSED",
  "PENDING_FUNDING",
]);
...
export const updatePettyCashWithdrawalSchema = createPettyCashWithdrawalSchema.extend({
  id: z.string().cuid(),
...
export const updatePettyCashSpendSchema = createPettyCashSpendSchema.extend({
  id: z.string().cuid(),
