                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-sm text-yellow-800">
                        <div>
                            ...
                            <ul className="space-y-1">
                                <li>• <strong>Frontend:</strong> Envía montos en CENTAVOS</li>
                                <li>• <strong>Backend:</strong> Convierte a PESOS (÷100)</li>
                                <li>• <strong>Point Smart:</strong> Requiere mínimo $15.00</li>
                                <li>• <strong>Equivalencia:</strong> 1500 centavos = $15.00</li>
                            </ul>
                        </div>
                        <div>
                        ...
                        <div className="flex-1">
                            ...
                            {customAmount && (
                                <p className="text-xs text-gray-600 mt-1">
                                    = ${(parseInt(customAmount) / 100).toFixed(2)} pesos
                                </p>
                            )}
                        </div>
                        <Button
                    ...
                    {testResults.custom && (
                        <div className="mt-4 p-4 bg-purple-50 border border-purple-200 rounded-lg">
                            ...
                            <div className="text-sm space-y-1">
                                <p><strong>Monto enviado:</strong> {testResults.custom.amount} centavos</p>
                                <p><strong>Equivale a:</strong> ${testResults.custom.amountInPesos.toFixed(2)} pesos</p>
                                <p><strong>Estado:</strong>
                                    <span className={`ml-2 px-2 py-1 rounded text-xs font-medium ${testResults.custom.amountInPesos >= 15
            ...
            <div className="grid gap-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    {testCases.map((testCase) => (
                        <Card key={testCase.id} className={`${testCase.color === 'red' ? 'border-red-200 bg-red-50' : 'border-green-200 bg-green-50'}`}>
                            <CardHeader>
                                <CardTitle className="flex items-center justify-between text-base">
                                    <span>{testCase.title}</span>
                                    <Badge className={testCase.color === 'red' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'}>
                            ...
                            <CardContent>
                                <div className="space-y-3">
                                    <div className="text-xs space-y-1">
                                        <p><strong>Monto:</strong> {testCase.amount} centavos</p>
                                        <p><strong>Equivale a:</strong> ${(testCase.amount / 100).toFixed(2)} pesos</p>
                                        <p><strong>Resultado esperado:</strong> {testCase.expectedResult}</p>
                                    </div>
