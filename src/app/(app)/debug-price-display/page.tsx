            ...
            <Card className="mb-8">
                ...
                <CardContent>
                    <div className="space-y-2">
                        <p><strong>Modo actual:</strong> {mode}</p>
                        <p><strong>showCost():</strong> {showCost() ? "true" : "false"}</p>
                        <p><strong>showWholesale():</strong> {showWholesale() ? "true" : "false"}</p>
                        <p><strong>showRetail():</strong> {showRetail() ? "true" : "false"}</p>
                    </div>
                </CardContent>
            </Card>
