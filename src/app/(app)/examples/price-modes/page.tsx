        ...
        <div className="container mx-auto py-8">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">
                    Este ejemplo muestra cómo los diferentes modos de visualización de precios afectan la interfaz.
                    Utiliza los botones en la barra superior para cambiar entre modos.
                </p>
                <div className="mt-4 p-4 bg-muted rounded-md">
                    <p><strong>Modo actual:</strong> {
                        mode === 'all' ? 'Todos los precios (Costo, Mayorista, Minorista)' :
                            mode === 'retail-wholesale' ? 'Mayorista y Minorista' :
                                'Solo Minorista'
                    }</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {motorcycles.map((moto) => (
                    <Card key={moto.id}>
                        <CardHeader>
                            <CardTitle>{moto.brand} {moto.model}</CardTitle>
