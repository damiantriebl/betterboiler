...
import { FileText, Image as ImageIcon, X as XIcon, Loader2 } from "lucide-react";
...
export function ModelFilesModal({
    ...
    const handleFileUpload = async ({ originalFile }: UploadResult) => {
        try {
            setIsUploading(true);
            console.log('Starting file upload:', { modelId, brandName, fileName: originalFile.name, fileType: originalFile.type });
