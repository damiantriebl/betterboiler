...
export default function OtpConfirmationModal({
    ...
    useEffect(() => {
        ...
        return () => { // Cleanup en desmontaje o cuando isOpen cambie
            if (timerRef.current) {
                clearInterval(timerRef.current);
            }
        };
        ...
        <Dialog open={isOpen} onOpenChange={handleModalOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Para eliminar {itemName}, por favor ingrese el código de un solo uso
                ...
                <div className="flex flex-col items-center space-y-4 py-4">
                    ...
                    {timeLeft > 0 ? (
                        ...
                        <p className="text-sm text-destructive">
                            El tiempo para ingresar el código ha expirado. Por favor, cierre e intente de nuevo con un nuevo código.
                        </p>
                    )}
                </div>
