    ...
    const handleRestart = async () => {
        ...
        try {
            ...
            setTimeout(() => {
                setResult({
                    success: true,
                    message: 'Para aplicar los cambios, detén el servidor con Ctrl+C y reinícialo con "pnpm run dev"'
                });
    ...
    return (
        <div className="container py-10">
            ...
            <Card className="mb-6">
                ...
                <CardContent>
                    <p className="mb-4">
                        Después de corregir los errores en las consultas, es necesario reiniciar el servidor
                        de desarrollo para que los cambios surtan efecto.
                    </p>
            ...
            {result.success !== undefined && (
                <Alert variant={result.success ? "default" : "destructive"} className="mb-6">
                    <div className="flex items-center gap-2">
                        ...
                        <AlertTitle>
                            {result.success ? 'Listo para reiniciar' : 'Error'}
                        </AlertTitle>
                    </div>
                    <AlertDescription>
                        {result.message}
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="list-disc pl-6 space-y-2">
                        <li>Corregida la consulta en <code>getEnabledBankingPromotions</code></li>
                        <li>Corregida la consulta en <code>getPromotionsForDay</code></li>
