    ...
    const handleFixPaymentMethods = async () => {
        ...
        try {
            ...
            if (response.success) {
                setResult({
                    success: true,
                    message: "¡Método de pago 'Cuenta Corriente' configurado correctamente! Regresa a la página de ventas y debería aparecer en el selector."
                });
            }
        } catch (error) {
            setResult({
                ...
                <Card>
                    ...
                    <CardContent>
                        <ol className="list-decimal pl-5 space-y-2">
                            ...
                            <li>Si sigue sin aparecer en la página de ventas, verifica la consola del navegador para ver mensajes de error.</li>
                            <li>Asegúrate de que estás usando la misma organización en ambas páginas.</li>
                            <li>Si el problema persiste, puede ser necesario revisar la configuración de la base de datos.</li>
                        </ol>
                    </CardContent>
                </Card>
            </div>
