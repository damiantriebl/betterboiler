    ...
    <div className="space-y-6">
      <Card className="p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input id="organization-name" placeholder="Nombre de tu empresa" disabled />
          ...
          <div>
            ...
            <Input id="organization-phone" placeholder="+54 11 1234-5678" disabled />
          </div>
      ...
      <Card className="p-6 bg-blue-50 border-blue-200">
        ...
        <p className="text-sm text-blue-800">
          Para configurar métodos de pago, ve a la pestaña correspondiente en la navegación
          superior.
        </p>
      </Card>
    </div>
