...
export const columns: ColumnDef<Client>[] = [
    ...
    },
    {
        accessorKey: "phone",
        header: "Teléfono",
        cell: ({ row }) => row.original.phone || <span className="text-muted-foreground italic">N/A</span>,
    },
    {
        accessorKey: "taxId",
        header: "CUIT/CUIL",
        cell: ({ row }) => row.original.taxId || <span className="text-muted-foreground italic">N/A</span>,
    },
    {
        accessorKey: "status",
        header: ({ column }) => {
        ...
        cell: ({ row }) => {
            ...
            return (
                <Badge variant={status === 'active' ? 'default' : 'outline'}
                    className={status === 'active' ? 'bg-green-100 text-green-800 border-green-300' : 'bg-gray-100 text-gray-600 border-gray-300'}>
