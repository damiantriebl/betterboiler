...
import { motorcycleBatchSchema, type MotorcycleBatchFormData } from "@/zod/MotorcycleBatchSchema";
...
export default async function EditMotorcyclePage({ params }: EditMotorcyclePageProps) {
    ...
    const [motorcycle, formData] = await Promise.all([
        ...
        <main className="flex flex-col gap-6 p-6">
            ...
            <form action={formAction}>
                <NewMotoForm
                    ...
                    onSubmit={(e) => { /* No hacer nada, action se encarga */ }}
                />
