...
export default function BrandContainer({
    ...
    return (
        ...
        >
            <CardHeader
                className="flex flex-row items-center justify-between p-3 bg-muted/30 rounded-t-lg border-b"
            >
                <div className="flex items-center gap-2 flex-grow min-w-0">
                    {/* Botón para Drag */}
                    <Button variant="ghost" size="icon" className="cursor-grab h-7 w-7" {...dragAttributes} {...dragListeners} aria-label="Mover marca">
                ...
                <div className="flex items-center gap-1 ml-auto">
                    ...
                    {onDelete && (
                        <Button variant="ghost" size="icon" onClick={onDelete} className="h-7 w-7 text-destructive" aria-label="Eliminar asociación de marca">
