...
export default function AddBranchItem({ onAdd, className, isAdding: isActionPending }: AddBranchItemProps) {
                ...
                {!isEditingMode ? (
                    ...
                    <>
                        <Input
                            ...
                            disabled={isActionPending}
                        />
                        <Button variant="default" size="icon" onClick={handleAddClick} disabled={!sucursalName.trim() || isActionPending} className='h-7 w-7'>
                            <Check className='h-4 w-4' />
                        </Button>
                        <Button variant="ghost" size="icon" onClick={handleCancel} disabled={isActionPending} className='h-7 w-7'>
