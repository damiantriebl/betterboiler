...
import { Check, CreditCard, ArrowRightLeft, ArrowLeftRight, Trash2 } from "lucide-react";
import { associatePaymentCard, removePaymentCard, togglePaymentCard, updatePaymentCardsOrder } from "@/actions/payment-cards/manage-payment-cards";
import { type PaymentCard, type OrganizationPaymentCardDisplay } from "@/types/payment-cards";
...
export default function ManagePaymentCards({
    ...
    const [organizationCards, setOrganizationCards] = useState<OrganizationPaymentCardDisplay[]>(
        initialOrganizationCards
    );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Estas tarjetas estarán disponibles para usar en ventas. Puede reordenarlas arrastrándolas.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
