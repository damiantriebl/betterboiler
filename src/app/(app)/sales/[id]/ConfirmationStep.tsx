      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-green-50 rounded-lg">
            ...
            <p>
              <span className="font-medium">Cliente:</span> {buyerData.nombre} {buyerData.apellido}
            </p>
            <p>
            ...
            <p>
              <span className="font-medium">Método de pago:</span> {paymentData.metodoPago}
            </p>
            {paymentData.metodoPago === "tarjeta" &&
              paymentData.cuotas &&
              paymentData.cuotas > 1 && (
                <p>
