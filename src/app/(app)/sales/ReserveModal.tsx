...
interface ReserveModalProps {
    ...
    motorcycleId: number;
    clients: Client[];
    onReserved: (data: { motorcycleId: number; reservationId: number; amount: number; clientId: string }) => void;
}

export function ReserveModal({ open, onClose, motorcycleId, clients, onReserved }: ReserveModalProps) {
