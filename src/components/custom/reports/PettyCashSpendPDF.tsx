      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            ...
            <View style={styles.tableColHeader}>
              <Text style={styles.tableCellHeader}>Sucursal</Text>
            </View>
            <View style={styles.tableColHeader}>
              <Text style={styles.tableCellHeader}>Motivo/Gasto</Text>
            </View>
            <View style={styles.tableColHeader}>
          ...
          {movements.map((movement) => (
            <View key={movement.id} style={styles.tableRow}>
              <View style={styles.tableCol}>
                <Text style={styles.tableCell}>{formatDate(movement.date)}</Text>
              </View>
              <View style={styles.tableCol}>
              ...
              <View style={styles.tableCol}>
                <Text style={styles.tableCell}>{movement.motive || "-"}</Text>
              </View>
              <View style={styles.tableCol}>
                <Text style={styles.tableCell}>{movement.description}</Text>
              </View>
              <View style={styles.tableCol}>
                <Text style={styles.tableCell}>{formatCurrency(movement.amount)}</Text>
              </View>
            </View>
          ))}
        </View>
