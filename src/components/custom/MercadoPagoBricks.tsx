    ...
    useEffect(() => {
        ...
        const initializeMercadoPago = async () => {
            try {
                ...
                const configResponse = await fetch(`/api/configuration/mercadopago/organization/${organizationId}`);
                ...
                const methodsResponse = await fetch(`/api/payments/mercadopago/methods?organizationId=${organizationId}`);
