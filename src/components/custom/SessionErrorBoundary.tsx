      ...
      <div className="max-w-md mx-auto text-center p-6">
        <div className="w-16 h-16 mx-auto mb-4">
          <svg
            ...
            viewBox="0 0 24 24"
          >
            <title>Session error icon</title>
            <path
              strokeLinecap="round"
        ...
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Error de Sesión</h2>
        ...
        <div className="flex items-center justify-center">
          ...
          <span className="ml-2 text-sm text-gray-500">Redirigiendo...</span>
        </div>
      </div>
    </div>
  );
...
export default function SessionErrorBoundary({
  ...
  if (sessionError?.startsWith("Error interno:")) {
