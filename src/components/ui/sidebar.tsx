...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      className={cn("size-12 m-4 ", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
      {...props}
    >
      <PanelLeft className="[&>svg]:size-12 [&>svg]:shrink-0" />
    ...
    >
      <div className="flex flex-col shrink-0 px-4 py-4 gap-3">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          {state === "expanded" && (
            <span className="font-semibold text-white truncate whitespace-nowrap">
              {organizationName}
            </span>
          )}
        </div>
  ...
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-6 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        black:
          "gap-4 p-7 bg-black text-white opacity-80 hover:bg-[#1a1a1a] hover:text-white active:bg-[#2a2a2a]",
        outline:
