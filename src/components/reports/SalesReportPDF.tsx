    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Total de Ventas: {report.summary.totalSales}</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text>
            Ingresos Totales: ${report.summary.totalRevenue[mainCurrency]?.toLocaleString()}
          </Text>
          <Text>Ganancia Total: ${report.summary.totalProfit[mainCurrency]?.toLocaleString()}</Text>
          <Text>
            Precio Promedio: ${report.summary.averagePrice[mainCurrency]?.toLocaleString()}
          </Text>
        </View>
