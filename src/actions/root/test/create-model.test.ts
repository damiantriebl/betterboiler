...
describe('createModel', () => {
  ...
  describe('Casos exitosos - Input como FormData', () => {
    ...
    it('debería manejar archivos en FormData', async () => {
      ...
      const mockAdditionalFile = new File(['manual content'], 'manual.pdf', { type: 'application/pdf' });
      ...
      expect(mockUploadToFolder).toHaveBeenNthCalledWith(3, mockAdditionalFile, 'models/2/additional');
