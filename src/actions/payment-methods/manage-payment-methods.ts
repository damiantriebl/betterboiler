...
export async function togglePaymentMethod(
  ...
  try {
    ...
    return { success: true, message: `Método de pago ${isEnabled ? "habilitado" : "deshabilitado"} correctamente.` };
  } catch (error: any) {
    console.error("Error updating payment method status:", error);
    return { 
      success: false, 
      error: "No se pudo actualizar el método de pago. Es posible que la tabla no exista todavía o que haya un problema con la conexión." 
    };
  }
}
...
export async function associatePaymentMethod(
  ...
  try {
    ...
    return { 
      success: false, 
      error: "No se pudo asociar el método de pago. Es posible que la tabla no exista todavía o que haya un problema con la conexión." 
    };
  }
}
...
export async function removePaymentMethod(
  ...
  try {
    ...
    return { 
      success: false, 
      error: "No se pudo eliminar el método de pago. Es posible que la tabla no exista todavía o que haya un problema con la conexión." 
    };
  }
}
...
export async function updatePaymentMethodsOrder(
  ...
  try {
    ...
    return { 
      success: false, 
      error: "No se pudo actualizar el orden de los métodos de pago. Es posible que la tabla no exista todavía o que haya un problema con la conexión." 
    };
  }
} 