...
export async function getMercadoPagoConfiguration(organizationId: string): Promise<MercadoPagoConfiguration | null> {
  try {
...
export async function validateMercadoPagoConfiguration(configuration: Partial<MercadoPagoConfiguration>): Promise<boolean> {
