...
import { motorcycleBatchSchema, unitIdentificationSchema, type MotorcycleBatchFormData, type UnitIdentificationFormData } from "@/zod/NewBikeZod";
...
export async function createMotorcycleBatch(prevState: CreateBatchState | null, data: MotorcycleBatchFormData): Promise<CreateBatchState> {
