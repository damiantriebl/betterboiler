...
export const colores = ["Negro", "Rojo", "Azul", "Blanco", "Gris", "Verde", "Amarillo", "Naranja"] as const;
export const ubicaciones = ["Buenos Aires", "Córdoba", "Rosario", "Mendoza", "La Plata", "Mar del Plata", "San Miguel de Tucumán"] as const;
...
Object.entries(modelos).forEach(([marca, modelosList], brandIndex) => {
    modelosList.forEach((modelo, modelIndex) => {
        ...
        años.forEach((año, yearIndex) => {
            ...
            const precio = cilindrada * 15000 + getNumberFromIndices(brandIndex, modelIndex, yearIndex, 500000);
            const kilometraje = año === 2024 ? 0 : getNumberFromIndices(brandIndex, modelIndex, yearIndex, 1000);
