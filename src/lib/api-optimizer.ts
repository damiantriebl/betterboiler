...
import { getCacheHeaders, getPerformanceHeaders, optimizeJsonResponse } from "./performance-config";
import { CACHE_TTL, responseCache } from "./response-cache";
...
function streamJsonResponse<T>(data: T, status = 200): NextResponse {
