  ...
  try {
    ...
    for (const org of organizations) {
      ...
      if (!association) {
        ...
        console.log(`Asociación encontrada: ID ${association.id}, isEnabled: ${association.isEnabled}, order: ${association.order}`);
      ...
      allMethods.forEach(m => {
        console.log(`- ${m.method.name} (${m.method.type}): isEnabled=${m.isEnabled}, order=${m.order}`);
      });
    }
